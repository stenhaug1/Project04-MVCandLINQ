...
string stageinpu = Console.ReadLine();
...
(string.IsNullOrEmpty(stageinpu) || a.Stag.Equals(stageinpu, StringComparison.OrdinalIgnoreCase)) &&
...
{
    Console.WriteLine($"{a.Number} {a.Name} stage is currently {a.Stag} the type is {a.Type} ");
    i2++;
}
